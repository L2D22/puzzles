// Q: sort ascending odd numbers but even numbers must be on their places.
// EX: sortArray([5, 3, 2, 8, 1, 4]) = [1, 3, 2, 8, 5, 4]
const arr = [5, 3, 2, 8, 1, 4]
function sortOddArray(arr) {

}
console.log('result', sortOddArray(arr)); // [1, 3, 2, 8, 5, 4]
